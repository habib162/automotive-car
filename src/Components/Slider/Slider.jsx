        ...
        <div>
            <div className="carousel w-full h-[630px] rounded-box">
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <div className="hero h-[630px]" style={{ backgroundImage: 'url(https://i.ibb.co/RyXvyXm/cover2.jpg)' }}>
                        <div className="hero-overlay bg-opacity-60"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <div className="hero h-[630px]" style={{ backgroundImage: 'url(https://i.ibb.co/jWzfvS7/cover3.jpg)' }}>
                        <div className="hero-overlay bg-opacity-60"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    <div className="hero h-[630px]" style={{ backgroundImage: 'url(https://i.ibb.co/WGr0CdT/cover5.jpg)' }}>
                        <div className="hero-overlay bg-opacity-60"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                                <h1 className="mb-5 text-5xl font-bold">Your Love Story Unfolds</h1>
                                <p className="mb-5">Where love begins and memories are made.</p>
                            </div>
                        </div>
                    </div>
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
